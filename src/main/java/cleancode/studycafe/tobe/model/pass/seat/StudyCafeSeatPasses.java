...
public class StudyCafeSeatPasses {
    ...
    public List<StudyCafeSeatPass> findPassBy(StudyCafeSeatPassType studyCafeSeatPassType) {
        return passes.stream()
                .filter(studyCafePass -> studyCafePass.isSamePassType(studyCafeSeatPassType))
                .toList();
    }
}
